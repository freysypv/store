...
export default function CreatePost({ onPostCreated }) {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        setImagePreview(reader.result); // This creates the base64 URL string
      };
  ...
  const handleSubmit = (e) => {
    ...
    // Block submission if both inputs are empty
    ...
    const newPost = {
      ...
      text: postText.trim(),
      image: imagePreview, // Saved as base64 string asset
